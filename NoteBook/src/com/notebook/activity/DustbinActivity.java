	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> adapterView, View view,
				...
				builder.setIcon(android.R.drawable.btn_star).setTitle("²Ù×÷").setMessage("ÄãÒª×öÊ²Ã´£¿");
				builder.setNegativeButton("»Ö¸´", new DialogInterface.OnClickListener() {
						...
						}).setNeutralButton("É¾³ý", new DialogInterface.OnClickListener() {
